...
public class GraphBuilder
{
   ...
   /* private static UndirectedGraph<BlockNode, DefaultEdge> createBlockNodeGraph()
    ...
    private Double partialSymmetry(ArrayList states, ElementsToPlace objElemP,int height,int floor,int maxObjLeft,boolean futureSymmetry) {
        ...
        symmetryV=symettry1(states, objElemP, xCenterMassGeneral, yCenterMassGeneral,xCenterMassCoins, yCenterMassCoins, futureSymmetry);
    ...
    private void validateBestBranchDepthSearchCenterFrame(ArrayList states, ElementsToPlace objElemP,int height,int floor,int maxObjLeft) {
        ...
        //here we will calculate the center of mass
        centerOfMassDepthSearchCenterFrame(states,objElemP,height,floor);
        symmetryV=symettry1(states, objElemP, xCenterMassGeneral, yCenterMassGeneral,xCenterMassCoins, yCenterMassCoins,false);
        double DistanceX=distanceBetweenX(states, objElemP, xCenterMassGeneral, yCenterMassGeneral,xCenterMassCoins, yCenterMassCoins);
		...
		while(itSymmetry1.hasNext()){
	        ...
	        if((xInitial+widthElement)<=xCenterMassGeneral )
	        {
	        	...
	        	else if(yInitial-heigthElement>=yCenterMassGeneral)
	        	{
	        		...
	        		partialWidth[2]=partialWidth[2]+(gulAG[2]);
	        		partialHeight[2]=partialHeight[2]+(gulAG[3]);
	        ...
	        else if(xInitial>=xCenterMassGeneral )
	        {
	        	...
	        	if(yInitial<=yCenterMassGeneral)
	        	{
	        		...
	        		partialWidth[1]=partialWidth[1]+(gulAG[2]);
	        		partialHeight[1]=partialHeight[1]+(gulAG[3]);
	        	}
	        	//block low right
	        	else if(yInitial-heigthElement>=yCenterMassGeneral)
	        	{
	        		...
	        		partialWidth[3]=partialWidth[3]+(gulAG[2]);
	        		partialHeight[3]=partialHeight[3]+(gulAG[3]);
	        	}
	        	else
	        	{
